...
class TestStructuralRetrieval(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('tools.rag.rag_service.ChatOllama') as MockLLM, \
             patch.object(RAGService, '_init_prompts'):
    ...
    def test_structural_retrieval_flow(self):
        ...
        self.mock_neo4j.get_neighborhood.return_value = [
            {"direction": "OUT", "relation": "CALLS", "name": "my_function", "type": "Function"},
            {"direction": "IN", "relation": "INHERITS", "name": "BaseClass", "type": "Class"},
            {"direction": "OUT", "relation": "BELONGS_TO", "name": "API_Layer", "type": "Concept"}
        ]
