...
class ImpactAnalyzer:
    ...
    def analyze_function_change(self, function_name: str, change_type: str = "signature") -> Dict[str, Any]:
        """
        ...
        with self.driver.session() as session:
            ...
            direct_callers = [{"id": r["id"], "name": r["name"], "file": r.get("file", "unknown"), "line": r["line"], "depth": 1} for r in direct_callers_res]
