...
def load_prompt_template(filename: str) -> ChatPromptTemplate:
    ...
    try:
        ...
        return ChatPromptTemplate.from_template("Error loading prompt. Context: {context}")
...
# Expose Prompts
ARCHITECTURE_PROMPT = load_prompt_template("git_analyzer_report.md") # Mapped to new file
